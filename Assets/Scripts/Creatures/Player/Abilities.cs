        ...
        private void Update()
        {
            foreach (Ability ability in abilities)
            {
                bool shouldShoot = ability.CanBeHoldDown
                    ? Input.GetKey(ability.KeyButton) || (ability.ThisMouseButton != Ability.MouseButton.None && Input.GetMouseButton((int)ability.ThisMouseButton))
                    : Input.GetKeyDown(ability.KeyButton) || (ability.ThisMouseButton != Ability.MouseButton.None && Input.GetMouseButtonDown((int)ability.ThisMouseButton));
